...
declare module '@material-ui/core/styles/withStyles' {
  ...
  declare export type EnhancedPropsTheme<E: {}, Keys: string> = $Diff<E, { classes: any, theme: any }> &
    StyledComponentProps<Keys>;

  declare export type EnhancedProps<E: {}, Keys: string> = $Diff<E, { classes: any }> &
    StyledComponentProps<Keys>
  ...
  declare export default {
    <ClassKey: string, Options: WithStylesOptions & { withTheme: true }>(
      ...
      EnhancedPropsTheme<React$ElementConfig<Comp>, ClassKey>
    >,
    <ClassKey: string, Options: WithStylesOptions & { withTheme?: false }>(
      ...
      EnhancedProps<React$ElementConfig<Comp>, ClassKey>
    >,
  };
}
